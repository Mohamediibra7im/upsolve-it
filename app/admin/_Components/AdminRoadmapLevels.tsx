                ...
                <TableRow key={lvl._id} className="hover:bg-card/20">
                  ...
                  <TableCell className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => handleOpenEdit(lvl)} className="rounded-xl h-8 w-8 hover:bg-secondary">
                        <Edit2 size={14} className="text-muted-foreground hover:text-foreground" />
                      </Button>
                      <Button variant="ghost" size="icon" onClick={() => handleDelete(lvl._id)} className="rounded-xl h-8 w-8 hover:bg-destructive/10">
