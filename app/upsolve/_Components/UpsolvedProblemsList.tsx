                    ...
                    >
                      <TableCell className="py-6 px-8">
                        <Link
                          ...
                          target="_blank"
                        >
                          <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-sm font-black text-primary border border-primary/20 transition-transform group-hover/link:scale-110">
                            {index + 1}
                          </div>
                      ...
                      <TableCell className="text-right px-8">
                        <Button
                          ...
                          className="h-10 w-10 rounded-xl hover:bg-rose-500/10 hover:text-rose-500 text-muted-foreground/40 transition-all"
                        >
              ...
              <CardContent className="p-6 space-y-6">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-sm font-black text-primary border border-primary/20">
                      {index + 1}
                    </div>
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() => onDelete(problem)}
                    className="h-9 w-9 rounded-lg hover:bg-rose-500/10 hover:text-rose-500 text-muted-foreground/40"
                  >
                ...
                >
                  <div className="p-4 rounded-2xl bg-muted/20 border border-border/20 group-hover:bg-primary/5 group-hover:border-primary/20 transition-all">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <ChevronRight className="h-4 w-4 text-muted-foreground/40 group-hover:text-primary group-hover:translate-x-1 transition-all flex-shrink-0" />
                    </div>
                  </div>
                </Link>
