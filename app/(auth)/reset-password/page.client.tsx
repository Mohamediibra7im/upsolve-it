            ...
            >
              <div className="space-y-6">
                <div className="p-8 rounded-[2rem] bg-amber-500/5 border border-amber-500/20 space-y-4 text-center">
                  <div className="size-16 rounded-2xl bg-amber-500/10 flex items-center justify-center text-amber-500 mx-auto border border-amber-500/20">
          ...
          {stage === "resetPassword" && (
            ...
            >
              <div className="p-8 rounded-[2rem] bg-emerald-500/5 border border-emerald-500/20 text-center space-y-3">
                <div className="size-14 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-500 mx-auto border border-emerald-500/20">
