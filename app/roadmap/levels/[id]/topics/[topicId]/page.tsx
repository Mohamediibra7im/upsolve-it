...
import {useRoadmapTopic} from "@/hooks/useRoadmap";
import VideoPlayer from "@/app/roadmap/_Components/VideoPlayer";
import {apiClient} from "@/lib/apiClient";
import {useToast} from "@/components/providers/Toast";
import useUser from "@/hooks/useUser";
import {cn} from "@/lib/utils";
import {progressWidthClass} from "@/app/roadmap/_Components/progressWidth";
import {
  Table,
  TableBody,
  TableCell,
...
const TopicPage = () => {
  ...
  return (
    <div className="min-h-screen pb-20 pt-0 relative overflow-hidden bg-[linear-gradient(to_right,rgba(var(--primary),0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(var(--primary),0.02)_1px,transparent_1px)] bg-[size:32px_32px]">
      ...
      <Orb className="w-[500px] h-[500px] bg-primary/6 dark:bg-primary/4 top-10 left-1/4 animate-pulse duration-[8s]" />
      <Orb className="w-[450px] h-[450px] bg-emerald-500/6 dark:bg-emerald-500/4 bottom-10 right-1/4 animate-pulse duration-[10s]" />
                              ...
                              >
                                <TableCell className="text-center py-4">
                                  <button
                                    ...
                                    className={cn(
                                      "h-5 w-5 rounded-md border flex items-center justify-center transition-all duration-300 cursor-pointer",
                                ...
                                <TableCell className="py-4">
                                  ...
                                  >
                                    ...
                                    <ExternalLink className="h-3.5 w-3.5 text-muted-foreground/35 opacity-0 group-hover/link:opacity-100 transition-opacity duration-300" />
                                  </button>
                                </TableCell>
