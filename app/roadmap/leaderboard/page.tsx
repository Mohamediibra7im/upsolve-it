...
import { useRoadmapLeaderboard, useRoadmapLevels } from "@/hooks/useRoadmap";
  ...
  return (
    <div className="min-h-screen relative pb-24">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-20 left-1/3 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-emerald-500/5 rounded-full blur-[100px] animate-pulse" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        >
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute -right-10 -bottom-10 h-40 w-40 rounded-full bg-emerald-500/10 blur-[80px]" />
          </div>
          ...
          <div className="relative z-10 space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-heading font-black uppercase tracking-tight text-foreground">
              Roadmap <span className="text-primary">Leaderboard</span>
            </h1>
                  ...
                  >
                    <div className="relative mb-3 shrink-0 group">
                      <div className="rounded-full p-[2px] bg-gradient-to-br from-zinc-300 to-zinc-400 shadow-lg shadow-zinc-400/10">
                        <Avatar className="h-16 w-16 sm:h-20 sm:w-20 border-[3px] border-background dark:border-zinc-900 group-hover:scale-105 transition-transform duration-300">
                  ...
                  >
                    <div className="relative mb-3 shrink-0 group">
                      <div className="rounded-full p-[3px] bg-gradient-to-br from-amber-300 to-amber-500 shadow-xl shadow-amber-400/20">
                        <Avatar className="h-20 w-20 sm:h-24 sm:w-24 border-[4px] border-background dark:border-zinc-900 group-hover:scale-105 transition-transform duration-300">
                      ...
                      <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-background dark:bg-zinc-900 border border-amber-400/40 rounded-full p-1.5 shadow-lg shadow-amber-500/15">
                        <Crown className="h-4.5 w-4.5 text-amber-400 drop-shadow-[0_0_4px_rgba(245,158,11,0.5)]" />
                      </div>
                    </div>
                  ...
                  >
                    <div className="relative mb-3 shrink-0 group">
                      <div className="rounded-full p-[2px] bg-gradient-to-br from-amber-600 to-amber-700 shadow-lg shadow-amber-700/10">
                        <Avatar className="h-14 w-14 sm:h-16 sm:w-16 border-[3px] border-background dark:border-zinc-900 group-hover:scale-105 transition-transform duration-300">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center">
                        {entry.rank <= 3 ? (
                          <div
                            className={cn(
                              "flex items-center justify-center h-8 w-8 rounded-lg text-xs font-black",
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="relative shrink-0">
                          <Avatar className="h-9 w-9 border border-border/60 dark:border-zinc-800 bg-background dark:bg-zinc-900">
                          ...
                          {entry.rank <= 3 && (
                            <span
                              className={cn(
                                "absolute -top-1 -right-1 h-3.5 w-3.5 rounded-full border-2 border-background dark:border-zinc-950 flex items-center justify-center text-[7px] font-black",
