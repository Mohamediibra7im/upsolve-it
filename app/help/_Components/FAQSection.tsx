        ...
        {filteredFAQs.length === 0 ? (
          <Card className="border-border/40 bg-card/20 backdrop-blur-xl rounded-[2.5rem]">
            <CardContent className="py-20 text-center space-y-4">
              <div className="h-16 w-16 rounded-2xl bg-muted/20 flex items-center justify-center mx-auto text-muted-foreground/40">
                <HelpCircle size={32} />
              </div>
              <div className="space-y-1">
                    ...
                    <CardContent className="p-0">
                      ...
                      >
                        <div className="flex items-start gap-6">
                          <div className={cn(
                            "mt-1 shrink-0 h-6 w-6 rounded-lg border border-border/40 flex items-center justify-center transition-all duration-500",
