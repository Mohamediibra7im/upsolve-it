  ...
  return (
    <section className={cn("relative w-full", className)}>
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute -top-24 left-1/2 h-[30rem] w-[30rem] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute -bottom-24 left-1/3 h-[26rem] w-[26rem] -translate-x-1/2 rounded-full bg-accent/10 blur-3xl" />
      </div>
          ...
          <div className="grid lg:grid-cols-12">
            <div className="relative lg:col-span-5">
              ...
              <div className="relative p-6 sm:p-10 lg:min-h-[32rem]">
                {icon ? (
                  <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-accent shadow-lg shadow-primary/15">
