            ...
            <Link href={category.href}>
              ...
              >
                <CardContent className="p-10 space-y-8">
                  <div className={cn(
                    "size-16 rounded-2xl flex items-center justify-center border transition-all duration-500 group-hover:rotate-6",
              ...
              {[
                ...
                >
                  <Link href={topic.href}>
                    <topic.icon className="size-4 mr-4 opacity-40 group-hover:opacity-100" />
