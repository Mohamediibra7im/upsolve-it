    ...
    <div className="max-w-4xl mx-auto space-y-12">
          ...
          return (
            ...
            >
              ...
              <div className="absolute left-0 top-2 flex items-center justify-center">
                <div className="size-16 rounded-2xl bg-card border border-border/40 flex items-center justify-center shadow-2xl relative z-10 group">
                  <div className="absolute inset-0 bg-primary/10 rounded-2xl blur-xl group-hover:blur-2xl transition-all" />
                  <Icon className="size-7 text-primary relative z-20" />
                </div>
              </div>
                      ...
                      <div className="space-y-3">
                        {step.steps.map((s) => (
                          <div key={`step-${step.id}-${s}`} className="flex items-start gap-3">
                            <div className="mt-1 size-4 rounded bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 shrink-0">
                              <CheckCircle size={10} />
                            </div>
      ...
      >
        <Card className="border-border/40 bg-emerald-500/5 backdrop-blur-xl rounded-[3rem] overflow-hidden p-10 sm:p-16 text-center space-y-8 relative">
          ...
          <div className="space-y-4">
            <div className="size-20 rounded-[2rem] bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mx-auto text-emerald-500 shadow-2xl shadow-emerald-500/20">
              <CheckCircle size={40} />
            </div>
