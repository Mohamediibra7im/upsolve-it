    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="relative overflow-hidden bg-card border-border p-6 rounded-2xl group">
          <div className="absolute top-0 right-0 size-32 bg-primary/10 blur-[50px] -mr-16 -mt-16 rounded-full" />
        ...
        <Card className="relative overflow-hidden bg-card border-border p-6 rounded-2xl group">
          <div className="absolute top-0 right-0 size-32 bg-amber-500/10 blur-[50px] -mr-16 -mt-16 rounded-full" />
          <div className="relative z-10 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="size-10 bg-secondary/50 border border-border rounded-xl hover:bg-secondary"
                >
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="size-2 rounded-full bg-primary shadow-[0_0_10px_rgba(var(--primary),0.5)]" />
