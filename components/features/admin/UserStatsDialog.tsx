          ...
          <>
            ...
            <div className="relative h-72 shrink-0 overflow-hidden bg-card/30 border-b border-border">
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute -top-[30%] -left-[10%] size-[600px] bg-primary/15 rounded-full blur-[140px] animate-pulse" />
                <div className="absolute -bottom-[30%] -right-[10%] size-[500px] bg-accent/10 rounded-full blur-[120px]" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="p-5 rounded-2xl bg-primary/5 border border-primary/10 flex items-center justify-between">
                          ...
                          <BarChart className="text-primary size-6 opacity-30" />
                        </div>
                      </div>
                    </div>
                  </CardContent>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <div className="size-8 rounded-lg bg-secondary border border-border flex items-center justify-center text-muted-foreground group-hover:text-primary transition-colors">
                                  <Calendar size={14} />
                                </div>
                                <div>
