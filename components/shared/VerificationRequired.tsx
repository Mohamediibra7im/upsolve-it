      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-start pt-32 sm:pt-40 justify-center bg-background/70 backdrop-blur-sm rounded-xl overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute top-10 left-1/2 -translate-x-1/2 w-96 h-96 rounded-full bg-primary/5 blur-[100px]" />
            <div className="absolute bottom-20 left-1/4 w-64 h-64 rounded-full bg-accent/5 blur-[80px]" />
          </div>
